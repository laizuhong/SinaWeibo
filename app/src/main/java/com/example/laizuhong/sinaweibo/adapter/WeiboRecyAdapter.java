...
public class WeiboRecyAdapter extends BaseQuickAdapter<Status>{

    private Context context;
    private List<Status> statuses;
    private TweetImageSpan tweetImageSpan;

    public WeiboRecyAdapter(Context context, List<Status> data) {
    ...
    @Override
    protected void convert(BaseViewHolder holer, Status status) {
            ...
            if (status.pic_urls.size() == 1) {
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(context, ImageActivity.class);
                        intent.putStringArrayListExtra("image", statuses.get(p).pic_urls);
            ...
            if (status.retweeted_status.pic_urls != null) {
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        int p= (int) parent.getTag();
                        Intent intent = new Intent(context, ImageActivity.class);
                        intent.putStringArrayListExtra("image", statuses.get(p).retweeted_status.pic_urls);
                        intent.putExtra("positon", position);
                        context.startActivity(intent);
                    }
                });
